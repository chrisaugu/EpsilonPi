var audioPlayer = function() {
  ...
  /**
   * Initializes the html5 audio audio-player and the playlist.
   *
   **/
  ...
  var _setTrackTitle = function(currentTrack, playListRows) {
    var trackTitleBox = document.querySelector(".audio-player .info-box .track-info-box .track-title-text");
  ...
  var _trackTimeChanged = function() {
    var currentTimeBox = document.querySelector(".audio-player .info-box .track-info-box .audio-time .current-time");
    var currentTime = audio.currentTime;
    var duration = audio.duration;
    var durationBox = document.querySelector(".audio-player .info-box .track-info-box .audio-time .duration");
