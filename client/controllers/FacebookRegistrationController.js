...
// EpsilonPi.controller('facebookRegistrationPopupController', function($scope, $rootScope, $http){
//     $rootScope.user = {type: null, isd: ""};
//     var response = JSON.parse(localStorage.getItem("isdDetails"));
//      if(response === null){
//     $http.get('/userapi/location?op_code=ip_location&version=2')
...
//
//
// EpsilonPi.controller('facebookRegistrationConflictController', function($scope, $rootScope, $http){
//
//     $scope.confirmation = function(selection){
//         $rootScope.selected_account = selection;
//         $rootScope.enable_back = true;
...
//
//
// EpsilonPi.controller('facebookLinkAccountController',function($scope, $http, $rootScope){
//     $(document).on('facebook_link_account_popup_opened',function(){
//         //$scope.mn_user = $rootScope.mn_user;
//         //$scope.selected_account = $rootScope.selected_account;
//         $scope.submit_disabled = false;
...
//
//
// EpsilonPi.controller('facebookLoginController',function($scope, $http, $rootScope){
//     $scope.submit_text = "Connect";
//     $scope.submit_disabled = false;
//     $(document).on('facebook_link_account_popup_opened',function(){
//         //$scope.mn_user = $rootScope.mn_user;
...
//
//
// EpsilonPi.controller('facebookRegistrationHeaderController', function($scope, $rootScope, $http){
//
//
//
//     $(document).on("fb_loaded",function(){
...
//
//
// EpsilonPi.controller('facebookLoadingController', function($scope, $rootScope, $http){
//
// });
//
//
// EpsilonPi.controller('facebookErrorController', function($scope, $rootScope, $http){
//
// });
//
// EpsilonPi.controller('joinNowController', function($scope, $rootScope, $http){
//     $scope.FBuser = 'FBuser';
//     $rootScope.submit_disabled = false;
//     $rootScope.submit_text = "Join Now";
//     //if($rootScope.join_now_vars != undefined){
